...
<div class="content">
    ...
    <div class="day__nav">
        <a class="nav__button" href="{{ route('admin.attendance_list', $yesterday) }}"><span>←</span>前日</a>

        <p class="current__month">{{ $date->format('Y/m/d') }}</p>

        <a class="nav__button" href="{{ route('admin.attendance_list', $tomorrow) }}">翌日<span>→</span></a>
    </div>
